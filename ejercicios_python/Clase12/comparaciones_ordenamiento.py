...
def experimento_vectores(Nmax):
    ...
    plt.plot(comparaciones_burbujeo, c='red', linestyle='dashed', label = 'Ord. Burbujeo')
...
# Se puede observar del gráfico que mientras mayor es la longitud de la lista, más evidente es la eficacia del algoritmo merge
# en cuanto a la cantidad de comparaciones que realiza, con respecto a los demás métodos de ordenamiento. 